...
gain_ki = [];
ci = [];
% count how many landmarks total
id_max=0;
estimated_landmarks = [];
...
while true
    ...
    if Phat(2,1)>0
        ...
        theta = 2*pi - acos(Phat(1,1));
    end
    
    estimated_trajectory = [estimated_trajectory, [Phat(1:2,3);theta]];
...
estimated_landmarks = [pbar(1,1:id_max);pbar(2,1:id_max)];
